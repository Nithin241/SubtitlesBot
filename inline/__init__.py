...
def inlinequery(update, context):
    ...
    inline = [
        [
            InlineKeyboardButton("Our Group", url="https://telegram.dog/Kanadarockersgroup"),
            InlineKeyboardButton("Our Channel", url="https://telegram.dog/NithinMovies")
        ]
    ]
    results = [
        InlineQueryResultDocument(
